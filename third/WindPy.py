...
class w:
    ...
    c_wupf.argtypes = [c_wchar_p, c_wchar_p, c_wchar_p, c_wchar_p, c_wchar_p,
                       c_wchar_p]  # PortfolioName,TradeDate,WindCode,Quantity,CostPrice,options

    c_tlogon = c_windlib.tLogon
    c_tlogon.restype = POINTER(c_apiout);
    c_tlogon.argtypes = [c_wchar_p, c_wchar_p, c_wchar_p, c_wchar_p, c_wchar_p,
                         c_wchar_p]  # BrokerID,DepartmentID,LogonAccount,Password,AccountType,loptions
    ...
    c_torder.argtypes = [c_wchar_p, c_wchar_p, c_wchar_p, c_wchar_p,
                         c_wchar_p]  # SecurityCode,TradeSide,OrderPrice,OrderVolume,loptions
    ...
    c_bktorder.argtypes = [c_wchar_p, c_wchar_p, c_wchar_p, c_wchar_p,
                           c_wchar_p]  # TradeTime,SecurityCode,TradeSide,TradeVol,options
    ...
    def wupf(PortfolioName, TradeDate, WindCode, Quantity, CostPrice, options=None, *arga, **argb):
        ...
        options = w.__t2options(options, arga, argb);
        if (
                PortfolioName == None or TradeDate == None or WindCode == None or Quantity == None or CostPrice == None or options == None):
            print('Invalid arguments!');
            return;
    ...
    def tlogon(BrokerID, DepartmentID, LogonAccount, Password, AccountType, options=None, *arga, **argb):
        ...
        options = w.__t2options(options, arga, argb);
        if (
                BrokerID == None or DepartmentID == None or LogonAccount == None or Password == None or AccountType == None or options == None):
            print('Invalid arguments!');
            return;
