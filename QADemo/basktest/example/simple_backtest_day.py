...
from QADemo.basktest.example.indicator.macd import MACD_JCSC
from matplotlib import pyplot as plt

try:
    if QA.__version__ > '1.1.0':
        QA.QA_util_log_info(QA.__version__)
    else:
    ...
    for peroid_item in DATA.panel_gen:
        ...
        for stock_item in peroid_item.security_gen:
            ...
            if cur_sotck_operation_towards == QA.ORDER_DIRECTION.BUY:
                ...
                print("可用资金: %s, 预计买入 %s , %s, %s, %s,股" % (
                    maxMoney, cur_stock_code, cur_stock_date, avgPrice, maxBuyAmount))
                order = AC.send_order(
...
if __name__ == '__main__':
    ...
    backtest_code_list = '601318'
    backtest_start_date = '2015-08-01'
